...
object Dependencies {
  ...
  val scalaMock = "org.scalamock" %% "scalamock-core" % "2.4" % "	test"
  val scalaMockScalaTest = "org.scalamock" %% "scalamock-scalatest-support" % "2.4" % "test"
  ...
  val jacksonCore = "com.fasterxml.jackson.core" % "jackson-core" % "2.1.2"
  val jacksonModuleScala = "com.fasterxml.jackson.module" % "jackson-module-scala" % "2.1.2"
